...
export const TextLink = styled.div`
  ...
  font-weight: 500;
  cursor: pointer;
  color: rgba(246, 154, 47, 1); // add constant color
`
...
export const SwiperCardSecound = styled.div`
  display: flex;
  position: relative;
  align-items: center;
  gap: 16.22px;
  width: 257px;
  height: 75px;
  background-color: rgba(214, 183, 255, 0.2);
  color: ${({ theme }) => theme.color.text};
  border-radius: 6px;
  padding: 8px;
  cursor: grab;
...
export const SvgTitleSecound = styled.div``

export const ContentCardSecound = styled.div`
  display: flex;
  flex-direction: column;
  align-items: start;
  margin-left: -20px;
...
export const TitleCardSecound = styled.div`
  font-size: 16px;
  font-weight: 500;
`

export const TextLinkSecound = styled.div`
  display: flex;
  align-items: center;
  font-size: 12px;
  font-weight: 500;
  cursor: pointer;
  color: rgba(164, 95, 255, 1); // add constant color
  svg {
    path {
      fill: rgba(164, 95, 255, 1);
    }
  }
`
